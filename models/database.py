...
class DatabaseModel:
    ...
    def _check_mysql_available(self):
        ...
        try:
            ...
            print("MySQL connector not installed. Running without database.")
            self._mysql_available = False
        return self._mysql_available

    def connect(self):
        """Establish database connection"""
        if not self._check_mysql_available():
            return False
    ...
    def initialize_database(self):
        ...
        if not self.connect():
            print("Database not available - running in file-only mode")
            return False
